...
Public Class Compare_Class_Percentages
    ...
    Private Sub CompareClass_Percentages(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub Levelfield_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Levelfield.SelectedIndexChanged
        ...
        ElseIf Levelfield.Text <> "" And Yearfield.Text <> "" And SubjectField.Text <> "" Then
            Classfieldgenerate()
        End If
    ...
    Public Sub kS4percentages()
        ...
        sql = "SELECT Grade.Grade, Grade.DatasetID, Grade.LevelID, Class.ClassGroup FROM StudentGroup INNER JOIN Subject INNER JOIN  Class ON Subject.SubjectID = Class.SubjectID INNER JOIN Student INNER JOIN Grade ON Student.StudentID = Grade.StudentID ON Subject.SubjectID = Grade.SubjectID ON StudentGroup.ClassID = Class.ClassID AND  StudentGroup.StudentID = Student.StudentID WHERE Class.ClassGroup = '" & Classgroupfield.Text & "'"
        ...
        If p = 0 Then
            ...
            Table1label.Text = "Class " & p + 1 & ": " & SubjectField.Text & " " & Yearfield.Text & ", " & vbCrLf & Classgroupfield.Text
        ...
        If p = 1 Then
            ...
            Table2label.Text = "Class " & p + 1 & ": " & SubjectField.Text & " " & Yearfield.Text & ", " & vbCrLf & Classgroupfield.Text
        ...
        If p = 2 Then
            ...
            Table3label.Text = "Class " & p + 1 & ": " & SubjectField.Text & " " & Yearfield.Text & ", " & vbCrLf & Classgroupfield.Text
        ...
        If p = 3 Then
            ...
            Table4label.Text = "Class " & p + 1 & ": " & SubjectField.Text & " " & Yearfield.Text & ", " & vbCrLf & Classgroupfield.Text
        ...
        If Graphtypefield.Text = "Cumulative Grade Percentage Graph" Then
            ...
            series = "Class " & p + 1 & ": " & SubjectField.Text & " " & Yearfield.Text & ", " & Classgroupfield.Text
            ...
            Classespercentageschart.Series(series).Points.AddY((Agrade + Astargrade) / dt.Rows.Count)
            Classespercentageschart.Series(series).Points.AddY((Bgrade + Astargrade + Agrade) / dt.Rows.Count)
            Classespercentageschart.Series(series).Points.AddY((Cgrade + Astargrade + Agrade + Bgrade) / dt.Rows.Count)
            Classespercentageschart.Series(series).Points.AddY((Dgrade + Astargrade + Agrade + Bgrade + Cgrade) / dt.Rows.Count)
            Classespercentageschart.Series(series).Points.AddY((Egrade + Dgrade + Astargrade + Agrade + Bgrade + Cgrade) / dt.Rows.Count)
            Classespercentageschart.Series(series).Points.AddY((Fgrade + Egrade + Dgrade + Astargrade + Agrade + Bgrade + Cgrade) / dt.Rows.Count)
            Classespercentageschart.Series(series).Points.AddY((Ggrade + Fgrade + Egrade + Dgrade + Astargrade + Agrade + Bgrade + Cgrade) / dt.Rows.Count)
        Else
            'name of the series is set dynamically depending on users choices
            series = "Class " & p + 1 & ": " & SubjectField.Text & " " & Yearfield.Text & ", " & Classgroupfield.Text
            'adds a series to the graph
    ...
    Public Sub KS2percentages()
        ...
        If Graphtypefield.Text = "Cumulative Grade Percentage Graph" Then
            ...
            Classespercentageschart.Series(series).Points.AddY(((fivegrade) / dt.Rows.Count))
            Classespercentageschart.Series(series).Points.AddY((((fourgrade + fivegrade) / dt.Rows.Count)))
            Classespercentageschart.Series(series).Points.AddY((((threegrade + fourgrade + fivegrade) / dt.Rows.Count)))
        ...
        Else
            ...
            Classespercentageschart.Series(series).Points.AddY(((fivegrade) / dt.Rows.Count))
            Classespercentageschart.Series(series).Points.AddY(((fourgrade) / dt.Rows.Count))
            Classespercentageschart.Series(series).Points.AddY(((threegrade) / dt.Rows.Count))
        End If
    ...
    Public Sub A2Predictions(ByVal sql2 As String)
        ...
        If p = 0 Then
            ...
            'this sets the label of the table, so the user knows what the data in the table correlates to
            Table1label.Text = "Subject " & p + 1 & ": " & SubjectField.Text & " A2 Predicts " & vbCrLf & Yearfield.Text & ", " & Classgroupfield.Text
            'this sets the atoc label text of the table by adding up all the grades from A* to c and then dividing by the total number of grades in the dataset, which is then converted to a percentage and displayed as a percentage
        ...
        If p = 1 Then
            ...
            Table2label.Text = "Subject " & p + 1 & ": " & SubjectField.Text & " A2 Predicts " & vbCrLf & Yearfield.Text & ", " & Classgroupfield.Text
        ...
        If p = 2 Then
            ...
            Table3label.Text = "Subject " & p + 1 & ": " & SubjectField.Text & " A2 Predicts " & vbCrLf & Yearfield.Text & ", " & Classgroupfield.Text
        ...
        If p = 3 Then
            ...
            Table4label.Text = "Subject " & p + 1 & ": " & SubjectField.Text & " A2 Predicts " & vbCrLf & Yearfield.Text & ", " & Classgroupfield.Text
        ...
        If Graphtypefield.Text = "Cumulative Grade Percentage Graph" Then
            'name of the series is set dynamically depending on users choices
            series = "Subject " & p + 1 & ": " & SubjectField.Text & " A2 Predicted " & Yearfield.Text & ", " & Classgroupfield.Text
            'adds a series to the graph
            Classespercentageschart.Series.Add(series)
            'adds datapoints to the series of the graph, these points work cumulatively so that each following data point adds all the previous data points values to it
            Classespercentageschart.Series(series).Points.AddY(Astargrade / dt3.Rows.Count)
            Classespercentageschart.Series(series).Points.AddY((Agrade + Astargrade) / dt3.Rows.Count)
            Classespercentageschart.Series(series).Points.AddY((Bgrade + Astargrade + Agrade) / dt3.Rows.Count)
            Classespercentageschart.Series(series).Points.AddY((Cgrade + Astargrade + Agrade + Bgrade) / dt3.Rows.Count)
            Classespercentageschart.Series(series).Points.AddY((Dgrade + Astargrade + Agrade + Bgrade + Cgrade) / dt3.Rows.Count)
            Classespercentageschart.Series(series).Points.AddY((Egrade + Dgrade + Astargrade + Agrade + Bgrade + Cgrade) / dt3.Rows.Count)
            Classespercentageschart.Series(series).Points.AddY((Fgrade + Egrade + Dgrade + Astargrade + Agrade + Bgrade + Cgrade) / dt3.Rows.Count)
        Else
            'name of the series is set dynamically depending on users choices
            series = "Subject " & p + 1 & ": " & SubjectField.Text & " A2 Predicted " & Yearfield.Text & ", " & Classgroupfield.Text
            'adds a series to the graph
        ...
        If textvalidate() = True Then
            ...
            Else
                ...
                Else
                    ...
                    Classespercentageschart.Series(p).ChartType = DataVisualization.Charting.SeriesChartType.Line
                    ...
                    Classespercentageschart.ChartAreas(0).AxisX.LabelStyle.ForeColor = Color.Maroon
                    Classespercentageschart.ChartAreas(0).AxisY.LabelStyle.ForeColor = Color.Maroon
